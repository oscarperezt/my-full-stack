...
import type { Body_login_login_access_token,Message,NewPassword,Token,UserPublic,UpdatePassword,UserCreate,UserRegister,UsersPublic,UserUpdate,UserUpdateMe,ItemCreate,ItemPublic,ItemsPublic,ItemUpdate,DeviceCreate,DevicePublic,DevicesPublic,DeviceUpdate,TelemetryData } from './models';
...
skip = 0,
	 ...
	 * @throws ApiError
	 */
	public static createDevice(data: TDataCreateDevice): CancelablePromise<DevicePublic> {
		const {
requestBody,
} = data;
		return __request(OpenAPI, {
...
export type TDataGetTelemetryData = {
                /**
 * Filter by engine ignition status
 */
engineIgnitionStatus?: boolean | null
/**
 * Filter by device identifier (ident)
 */
ident?: string | null
/**
...
offset?: number
/**
 * Filter by position latitude
 */
positionLatitude?: number | null
/**
 * Filter by position longitude
 */
...
export class ReportsService {
	 ...
	 * @throws ApiError
	 */
	public static receiveReport(): CancelablePromise<Record<string, string>> {
				return __request(OpenAPI, {
			method: 'POST',
			url: '/api/v1/reports/reports/',
		});
	}
	 ...
	 * @returns TelemetryData Successful Response
	 * @throws ApiError
	 */
	public static getTelemetryData(data: TDataGetTelemetryData = {}): CancelablePromise<Array<TelemetryData>> {
		const {
...
timestampTo,
		...
		return __request(OpenAPI, {
			...
			url: '/api/v1/reports/reports/',
			query: {
				limit, offset, ident, position_latitude: positionLatitude, position_longitude: positionLongitude, engine_ignition_status: engineIgnitionStatus, timestamp_from: timestampFrom, timestamp_to: timestampTo
			},
			errors: {
				422: `Validation Error`,
			},
